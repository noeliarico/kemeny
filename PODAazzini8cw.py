...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 1, 1, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 1, 2, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 1, 3, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 1, 4, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 1, 5, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 2, 1, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 2, 2, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 2, 3, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 2, 4, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 2, 5, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 3, 1, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 3, 2, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 3, 3, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 3, 4, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 3, 5, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 4, 1, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 4, 2, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 4, 3, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 4, 4, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 4, 5, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 5, 1, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 5, 2, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 5, 3, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 5, 4, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 5, 5, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 6, 1, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 6, 2, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 6, 3, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 6, 4, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 6, 5, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 7, 1, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 7, 2, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 7, 3, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 7, 4, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 7, 5, 5, exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results8 = np.vstack((results8, result))

 
pd.DataFrame(results8).to_csv("poda8cw_123.csv")