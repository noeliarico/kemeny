...
result = np.append(np.array([9, 2000, 1, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 2, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 3, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 4, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 5, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 6, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 7, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 8, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 9, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 10, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 11, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 12, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 13, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 14, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 15, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 16, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 17, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 18, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 19, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 20, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 21, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 22, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 23, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 24, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 25, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 26, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 27, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 28, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 29, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 30, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 31, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 32, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 33, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 34, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 35, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 36, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 37, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 38, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 39, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 40, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 41, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 42, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 43, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 44, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 45, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 46, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 47, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 48, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 49, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 50, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 51, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 52, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 53, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 54, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 55, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 56, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 57, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 58, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 59, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 60, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 61, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 62, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 63, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 64, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 65, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 66, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 67, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 68, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 69, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 70, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 71, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 72, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 73, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 74, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 75, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 76, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 77, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 78, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 79, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 80, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 81, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 82, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 83, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 84, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 85, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 86, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 87, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 88, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 89, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 90, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 91, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 92, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 93, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 94, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 95, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 96, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 97, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 98, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 99, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 100, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 101, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 102, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 103, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 104, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 105, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 106, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 107, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 108, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 109, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 110, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 111, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 112, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 113, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 114, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 115, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 116, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 117, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 118, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 119, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 120, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 121, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 122, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 123, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 124, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 125, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 126, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 127, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 128, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 129, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 130, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 131, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 132, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 133, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 134, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 135, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 136, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 137, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 138, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 139, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 140, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 141, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 142, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 143, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 144, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 145, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 146, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 147, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 148, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 149, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 150, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 151, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 152, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 153, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 154, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 155, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 156, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 157, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 158, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 159, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 160, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 161, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 162, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 163, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 164, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 165, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 166, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 167, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 168, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 169, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 170, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 171, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 172, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 173, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 174, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 175, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 176, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 177, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 178, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 179, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 180, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 181, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 182, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 183, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 184, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 185, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 186, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 187, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 188, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 189, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 190, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 191, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 192, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 193, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 194, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 195, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 196, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 197, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 198, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 199, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([9, 2000, 200, "ME-BBRCWd", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))

 
pd.DataFrame(results).to_csv("/Users/noeliarico/Desktop/folder-kemeny/2021EJOR/results/mebbrcwd/mebbrcwd_9_2000.csv", index=False, header=False)