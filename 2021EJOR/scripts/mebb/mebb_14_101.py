...
result = np.append(np.array([14, 101, 1, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 2, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 3, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 4, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 5, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 6, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 7, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 8, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 9, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 10, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 11, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 12, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 13, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 14, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 15, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 16, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 17, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 18, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 19, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 20, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 21, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 22, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 23, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 24, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 25, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 26, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 27, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 28, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 29, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 30, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 31, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 32, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 33, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 34, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 35, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 36, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 37, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 38, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 39, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 40, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 41, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 42, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 43, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 44, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 45, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 46, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 47, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 48, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 49, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 50, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 51, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 52, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 53, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 54, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 55, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 56, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 57, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 58, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 59, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 60, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 61, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 62, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 63, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 64, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 65, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 66, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 67, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 68, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 69, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 70, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 71, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 72, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 73, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 74, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 75, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 76, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 77, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 78, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 79, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 80, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 81, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 82, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 83, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 84, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 85, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 86, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 87, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 88, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 89, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 90, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 91, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 92, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 93, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 94, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 95, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 96, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 97, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 98, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 99, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 100, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 101, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 102, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 103, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 104, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 105, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 106, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 107, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 108, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 109, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 110, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 111, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 112, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 113, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 114, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 115, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 116, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 117, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 118, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 119, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 120, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 121, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 122, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 123, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 124, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 125, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 126, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 127, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 128, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 129, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 130, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 131, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 132, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 133, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 134, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 135, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 136, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 137, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 138, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 139, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 140, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 141, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 142, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 143, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 144, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 145, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 146, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 147, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 148, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 149, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 150, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 151, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 152, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 153, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 154, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 155, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 156, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 157, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 158, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 159, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 160, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 161, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 162, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 163, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 164, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 165, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 166, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 167, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 168, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 169, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 170, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 171, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 172, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 173, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 174, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 175, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 176, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 177, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 178, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 179, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 180, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 181, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 182, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 183, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 184, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 185, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 186, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 187, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 188, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 189, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 190, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 191, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 192, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 193, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 194, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 195, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 196, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 197, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 198, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 199, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([14, 101, 200, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))

 
pd.DataFrame(results).to_csv("/Users/noeliarico/Desktop/folder-kemeny/2021EJOR/results/mebb/mebb_14_101.csv", index=False, header=False)