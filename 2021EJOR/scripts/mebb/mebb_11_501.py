...
result = np.append(np.array([11, 501, 1, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 2, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 3, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 4, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 5, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 6, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 7, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 8, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 9, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 10, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 11, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 12, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 13, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 14, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 15, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 16, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 17, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 18, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 19, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 20, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 21, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 22, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 23, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 24, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 25, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 26, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 27, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 28, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 29, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 30, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 31, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 32, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 33, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 34, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 35, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 36, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 37, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 38, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 39, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 40, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 41, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 42, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 43, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 44, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 45, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 46, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 47, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 48, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 49, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 50, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 51, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 52, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 53, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 54, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 55, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 56, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 57, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 58, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 59, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 60, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 61, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 62, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 63, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 64, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 65, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 66, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 67, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 68, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 69, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 70, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 71, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 72, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 73, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 74, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 75, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 76, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 77, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 78, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 79, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 80, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 81, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 82, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 83, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 84, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 85, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 86, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 87, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 88, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 89, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 90, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 91, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 92, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 93, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 94, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 95, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 96, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 97, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 98, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 99, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 100, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 101, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 102, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 103, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 104, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 105, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 106, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 107, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 108, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 109, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 110, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 111, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 112, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 113, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 114, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 115, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 116, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 117, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 118, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 119, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 120, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 121, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 122, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 123, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 124, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 125, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 126, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 127, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 128, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 129, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 130, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 131, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 132, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 133, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 134, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 135, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 136, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 137, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 138, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 139, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 140, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 141, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 142, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 143, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 144, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 145, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 146, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 147, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 148, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 149, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 150, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 151, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 152, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 153, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 154, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 155, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 156, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 157, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 158, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 159, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 160, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 161, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 162, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 163, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 164, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 165, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 166, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 167, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 168, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 169, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 170, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 171, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 172, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 173, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 174, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 175, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 176, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 177, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 178, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 179, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 180, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 181, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 182, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 183, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 184, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 185, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 186, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 187, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 188, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 189, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 190, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 191, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 192, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 193, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 194, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 195, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 196, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 197, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 198, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 199, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([11, 501, 200, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))

 
pd.DataFrame(results).to_csv("/Users/noeliarico/Desktop/folder-kemeny/2021EJOR/results/mebb/mebb_11_501.csv", index=False, header=False)