...
result = np.append(np.array([8, 251, 1, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 2, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 3, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 4, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 5, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 6, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 7, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 8, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 9, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 10, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 11, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 12, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 13, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 14, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 15, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 16, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 17, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 18, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 19, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 20, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 21, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 22, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 23, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 24, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 25, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 26, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 27, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 28, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 29, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 30, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 31, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 32, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 33, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 34, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 35, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 36, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 37, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 38, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 39, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 40, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 41, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 42, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 43, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 44, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 45, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 46, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 47, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 48, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 49, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 50, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 51, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 52, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 53, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 54, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 55, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 56, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 57, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 58, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 59, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 60, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 61, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 62, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 63, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 64, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 65, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 66, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 67, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 68, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 69, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 70, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 71, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 72, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 73, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 74, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 75, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 76, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 77, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 78, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 79, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 80, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 81, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 82, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 83, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 84, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 85, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 86, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 87, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 88, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 89, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 90, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 91, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 92, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 93, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 94, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 95, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 96, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 97, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 98, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 99, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 100, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 101, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 102, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 103, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 104, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 105, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 106, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 107, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 108, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 109, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 110, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 111, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 112, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 113, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 114, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 115, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 116, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 117, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 118, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 119, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 120, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 121, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 122, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 123, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 124, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 125, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 126, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 127, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 128, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 129, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 130, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 131, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 132, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 133, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 134, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 135, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 136, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 137, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 138, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 139, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 140, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 141, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 142, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 143, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 144, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 145, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 146, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 147, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 148, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 149, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 150, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 151, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 152, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 153, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 154, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 155, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 156, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 157, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 158, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 159, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 160, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 161, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 162, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 163, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 164, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 165, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 166, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 167, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 168, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 169, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 170, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 171, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 172, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 173, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 174, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 175, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 176, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 177, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 178, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 179, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 180, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 181, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 182, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 183, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 184, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 185, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 186, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 187, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 188, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 189, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 190, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 191, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 192, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 193, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 194, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 195, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 196, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 197, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 198, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 199, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))
...
for i in range(rep):
    ...
    #print(t)
exec_time = np.median(times)
result = np.append(np.array([8, 251, 200, "ME-BB", exec_time, sol.shape[0], algorithm.ntentative], dtype=np.dtype(object)), times)
print(result[:7])
results = np.vstack((results, result))

 
pd.DataFrame(results).to_csv("/Users/noeliarico/Desktop/folder-kemeny/2021EJOR/results/mebb/mebb_8_251.csv", index=False, header=False)