...
comparar_fuzzieee(pors8cw, 8, "azzini8cw.py", rep = 3, type = "cw")
comparar_fuzzieee(pors9cw, 9, "azzini9cw.py", rep = 3, type = "cw")
comparar_fuzzieee(pors10cw, 10, "azzini10cw.py", rep = 3, type = "cw")
comparar_fuzzieee(pors11cw, 11, "azzini11cw.py", rep = 3, type = "cw")
comparar_fuzzieee(pors12cw, 12, "azzini12cw.py", rep = 1, type = "cw")
...
comparar_fuzzieee(pors10nc, 10, "azzini10nc.py", rep = 3, type = "nc")
comparar_fuzzieee(pors11nc, 11, "azzini11nc.py", rep = 3, type = "nc")
comparar_fuzzieee(pors12nc, 12, "azzini12nc.py", rep = 1, type = "nc")
